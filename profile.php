<?php
	...
	$login = new Login();
	$_SESSION['college_userid'] = isset($_SESSION['college_userid']) ? $_SESSION['college_userid'] : 0;
	
	$user_data = $login->check_login($_SESSION['college_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['college_userid']);

		}else{

			$post = new Post();
			$id = $_SESSION['college_userid'];
...
<!DOCTYPE html>
	<html>
	<head>
		<title>Profile | College Network</title>
	</head>
	...
	<body style="font-family: tahoma; background-color: #d0d8e4;">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<br>
					<div style="font-size: 20px;color: black;">
						...
						<a href="like.php?type=user&id=<?php echo $user_data['userid'] ?>">
							<input id="post_button" type="button" value="Follow <?php echo $mylikes ?>" style="margin-right:10px;background-color:lightblue;width:auto;color: black;">
						</a>
				...
				<?php 
					if($user_data['userid'] == $_SESSION['college_userid']){
